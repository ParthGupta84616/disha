...
export default function Dashboard() {
  ...
  const handleClick = (alumniId) => {
    // Format the URL to include the alumniId as a route parameter
    navigate(`/skills/${alumniId}`);
  };
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center flex-wrap">
                      <button
                        ...
                        className="flex items-center text-blue-500 cursor-pointer bg-transparent border-none transition"
                      >
                        View Skills
                        <svg
                      ...
                      <span className="text-green-200 mr-3 inline-flex items-center lg:ml-auto md:ml-0 ml-auto leading-none text-sm pr-3 border-r-2 border-gray-200 dark:border-gray-600">
                        <svg
