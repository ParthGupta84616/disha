      ...
      <div className="flex lg:py-56 justify-center items-center">
        <div className="text-center max-w-6xl mx-10">
          ...
          <div className="flex flex-col items-center justify-center gap-5 mt-6 md:flex-row">
            <Link
              className="inline-block w-auto text-center min-w-[200px] px-6 py-4 text-white transition-all rounded-[20px] shadow-xl sm:w-auto bg-gradient-to-r from-blue-600 to-blue-500 hover:bg-gradient-to-b dark:shadow-blue-900 shadow-blue-200 hover:shadow-2xl hover:shadow-blue-400 hover:-translate-y-px"
              to="/institute"
            >
              View Affiliated Institutes
            </Link>
            <Link
              className="inline-block w-auto text-center min-w-[200px] px-6 py-4 text-white transition-all bg-gray-700 dark:bg-white dark:text-gray-800 rounded-[20px] shadow-xl sm:w-auto hover:bg-gray-900 hover:text-white shadow-neutral-300 dark:shadow-neutral-700 hover:shadow-2xl hover:shadow-neutral-400 hover:-translate-y-px"
              to="/"
            >
              Learn More
            </Link>
