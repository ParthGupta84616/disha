              ...
              <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
                <li>
                  <Link
                    ...
                    rel="noreferrer"
                    target="_blank"
                    className="text-teal-100 transition hover:text-teal-200/75"
                  >
                ...
                <ul className="mt-8 space-y-4 text-lg xs:text-sm xs:text-md">
                  ...
                  <li>
                    ...
                    >
                      ...
                      <span className="flex-1 text-gray-100">8461991146</span>
                    </Link>
                  </li>
          ...
          <div className="mt-12  pt-6">
            <div className="text-center sm:flex sm:justify-between sm:text-left">
              <p className="text-lg text-gray-100">
                ...
                <Link
                  className="inline-block text-teal-100 underline transition hover:text-teal-100/75"
                  to="#"
                >
                  Terms & Conditions
                </Link>
